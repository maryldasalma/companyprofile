...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!--Page Header Start-->
        <?php 
            $detailgambar = $this->model_utama->view_where('sampulgambar', array('page' => 'program'))->row_array();
        ...
        <section class="project-one">
            ...
            <div class="row filter-layout masonary-layout">
                <?php 
                    $program = $this->model_utama->view_where('daftargambar', array('1' => '1'))->result_array();
                    if (!empty($program)): 
                        foreach ($program as $row): 
                ?>
                            <div class="col-xl-4 col-lg-6 col-md-6 filter-item <?php echo $row['kategori']; ?>">
                                <!--Portfolio One Single-->
                                <div class="project-one__single">
                                    <div class="project-one__img">
                                        <img src="<?php echo base_url('asset/img_daftargambar/' . $row['gbr_daftargambar']); ?>" alt="">
                                        <div class="project-one__hover">
                                            <p class="project-one__tagline"><?php echo $row['kategori']; ?></p>
                                            <h3 class="project-one__title" style="color: white;">
                                                <?php echo $row['jdl_daftargambar']; ?></a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
