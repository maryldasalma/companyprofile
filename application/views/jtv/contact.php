...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!--Page Header Start-->
        <?php 
            $detailgambar = $this->model_utama->view_where('sampulgambar', array('page' => 'contact'))->row_array();
        ...
        <section class="location">
           <div class="location-shape" style="background-image: url(asset/templateku/assets/images/shapes/location-shape.png)"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                       <!--Location Single-->
                        <div class="location__single">
                            ...
                            <p class="location__text"><?php echo $contact['about']; ?></p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4">
                       <!--Location Single-->
                        <div class="location__single">
                            ...
                            <p class="location__text"><?php echo $contact['address']; ?></p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4">
                       <!--Location Single-->
                        <div class="location__single location__single-last">
                            ...
                            <h5 class="location__phone-email">
                                <a href="tel:926668880000" class="location__phone"><?php echo $contact['contact']; ?></a>
                            </h5>
